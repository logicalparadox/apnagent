...
Message.prototype.expires = function (time) {
  this.meta.expires = time;
  this.meta.codec = null !== time && undefined !== time
    ? 'enhanced'
    : 'simple'
...
Message.prototype.serialize = function () {
  ...
  if ('enhanced' === codec && !this.meta.expires) {
 ...
 * Suggested use is only with an empty message. This
 * will not import the device, expiration or unique id.
 *
