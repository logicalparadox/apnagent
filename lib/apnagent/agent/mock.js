...
Mock.prototype.connect = function(cb) {
  ...
  var self = this;
  var delay = this.get('reconnect delay');
  var opts = util.gatewayOptions(this);
  var recon = this.enabled('reconnect');
  var ttl = this.get('cache ttl');
  var gateway;
...
Mock.prototype._queueIterator = function(obj, next) {
  ...
  var stream = encoder.stream(obj.codec);
  var id = obj.json.identifier;
