...
var APNS_PORT = 2195;
var APNS_PROD = 'gateway.push.apple.com';
var APNS_SANDBOX = 'gateway.sandbox.push.apple.com';
var FEED_PORT = 2196;
var FEED_PROD = 'feedback.push.apple.com';
var FEED_SANDBOX = 'feedback.sandbox.push.apple.com';
...
exports.gatewayOptions = function(agent) {
  var opts = {};
  opts.host = agent.enabled('sandbox') ? APNS_SANDBOX : APNS_PROD;
  opts.port = APNS_PORT;
...
exports.feedbackOptions = function(agent) {
  var opts = {};
  opts.host = agent.enabled('sandbox') ? FEED_SANDBOX : FEED_PROD;
  opts.port = FEED_PORT;
  exports.tlsOptions(agent, opts);
  return opts;
};
